...
> **Do not use this setup guide.** It configures the retired Cloud Anchor/Cloud Run approach. Use `BUILD_SPEC.md` v1.1 for the active marker-based build, including the required Android-and-iOS P0 device setup.
